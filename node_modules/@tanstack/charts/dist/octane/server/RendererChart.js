import { createElement as _$createElement, createPortal, hookSlots as _$hookSlots, memo, positionalChildren as _$positionalChildren, ssrChild as _$ssrChild, ssrStyle as _$ssrStyle, useId, useLayoutEffect, useMemo, useRef, useState } from "octane/server";
...
const RendererChart = function RendererChart2(props, __s, __extra) {
  ...
  return _$ssrChild(_$positionalChildren([
    _$createElement(
      "div",
      {
...
function DefaultTooltipBody({ content }, __s, __extra) {
...
function TooltipSwatch({ color }, __s, __extra) {
  return (() => {
    const __sp0 = {
      display: "block",
      width: "0.55rem",
    ...
    return '<span class="ts-chart-tooltip__swatch" aria-hidden="true"' + _$ssrStyle(__sp0) + "></span>";
  })();
}
export {
  RendererChart
