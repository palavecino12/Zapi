...
export const ScanInstruction = () => {
  ...
  return (
    ...
    className="flex flex-col items-center justify-center p-8 rounded-2xl shadow-xl max-w-sm mx-auto border border-orange-300 bg-slate-800">
      
      {/* Cuadro del Scanner */}
      <div className="relative w-56 h-56 bg-slate-300 rounded-xl flex items-center justify-center overflow-hidden border-2 border-dashed border-black/20 ">
