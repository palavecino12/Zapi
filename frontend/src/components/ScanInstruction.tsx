  ...
  return (
    <div className="flex flex-col items-center justify-center p-8 rounded-2xl shadow-xl max-w-sm mx-auto border border-gray-200 bg-white">
      ...
      <div className="relative w-52 h-52 bg-white rounded-xl flex items-center justify-center overflow-hidden border-2 border-dashed border-black/20 ">
        ...
        <svg className="w-40 h-40 text-black" fill="currentColor" viewBox="0 0 100 50">
        ...
        <div className="absolute top-5 left-4 w-6 h-6 border-t-4 border-l-4 border-black/50 rounded-tl-lg"></div>
        <div className="absolute top-5 right-4 w-6 h-6 border-t-4 border-r-4 border-black/50 rounded-tr-lg"></div>
        <div className="absolute bottom-5 left-4 w-6 h-6 border-b-4 border-l-4 border-black/50 rounded-bl-lg"></div>
        <div className="absolute bottom-5 right-4 w-6 h-6 border-b-4 border-r-4 border-black/50 rounded-br-lg"></div>
      </div>
      ...
      <p className="mt-2 text-sm text-center text-black">
        Centrá el código de barra del prudcto con la guia.
      </p>
    </div>
  );
};